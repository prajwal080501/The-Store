...
const ProductItem = ({ product }) => {
  return (
    <div className="max-w-2xl mx-auto">
      <div className="bg-white shadow-md rounded-lg max-w-sm h-1/2 md:w-[90%] mb-5">
        <a href="#">
          <img className="rounded-t-lg p-8 object-contain h-[20%} overflow-y-scroll" src={product.image} alt="product image" />
        </a>
