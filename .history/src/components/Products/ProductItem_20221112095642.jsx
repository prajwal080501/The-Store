...
const ProductItem = ({product}) => {
  return (
    <div>
        <div className="flex flex-col items-center justify-center w-[20vw] h-82 md:w-48 md:h-fit m-5 pb-2 rounded-lg shadow-md cursor-pointer hover:scale-105 duration-200 bg-white">
