      ...
      <div className="py-2 px-5 flex justify-between">
        ...
        <div className="flex-1 flex items-center justify-end space-x-7 mr-10">
          ...
          <div className="flex items-center w-fit h-fit">
            ...
            <div className="relative flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full text-black">
              <AiOutlineShoppingCart className="w-5 h-5" />
              <p className="absolute text-xs bg-red-400 w-1/2 text-black px-1 rounded-full absolute -top-1 right-0 font-bold">0</p>
              </div>
              </div>
        </div>
      </div>
