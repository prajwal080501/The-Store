      ...
      <div className="py-2 px-5 flex justify-between">
        ...
        <div className="flex-1 flex items-center justify-end space-x-7 mr-10">
          ...
          <div className="flex items-center w-fit h-fit">
            ...
            <div className="flex items-center justify-center w-8 h-8 bg-red-400 rounded-full text-white">
              <AiOutlineShoppingCart className="w-5 h-5" />

              <div className="absolute -top-1 -right-1 w-3 h-3 bg-red-400 rounded-full text-white text-xs flex items-center justify-center">
                0
                </div>
              </div>
              </div>
