      ...
      <div className="py-2.5 px-5 flex justify-between">
        <div className="flex-1 flex items-center space-x-8">
          ...
          <div className="flex items-center ml-[25px] space-x-8">
            <input className="bg-gray-100 drop-shadow-sm px-2 py-3 rounded-md outline-none active:ring-2 active:ring-red-500" type="text" placeholder="Search the market" />
