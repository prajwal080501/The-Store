...
const Sidebar = ({ isOpen, setIsOpen, handleOpen }) => {
    return (
        <div className={
            `
              ${isOpen ? 'w-[40vh]  bg-red-400 z-20  h-screen sticky absolute top-0 left-0' : 'hidden'}
           `
        }>
            <div className=" py-8">
            ...
            <div className="absolute bottom-0 left-0 w-full h-20 bg-red-400">
                <div className="flex justify-center items-center h-full">
                    <p className="text-white text-base font-semibold">The Pj Store Copyright &copy;</p>
                </div>
            </div>
