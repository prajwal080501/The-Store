...
const Navbar = () => {
  return (
    <div className="hidden lg:inline h-[60px] text-black drop-shadow-sm sticky top-0 z-10 bg-white">
      <div className=" px-5 bg-white opacity-50 h-full flex justify-between">
        <div className="flex-1 flex items-center space-x-8">
          ...
          <div className="flex items-center focus:ring-2 w-fit justify-between focus:ring-red-400 px-2 py-3 bg-gray-100 flex-1 ml-[25px]">
            <input className="drop-shadow-sm placeholder:text-lg placeholder:font-medium bg-transparent w-full  rounded-md outline-none text-red-500  duration-200 ease-linear" type="text" placeholder="Search the market" />
