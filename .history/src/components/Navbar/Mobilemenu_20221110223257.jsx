...
const Mobilemenu = () => {
    ...
    return (
        <div className="w-full h-[80px] flex  justify-between items-center lg:hidden bg-white p-5 ">
            ...
            <h1 className='text-2xl font-bold'>The <span className="text-4xl text-red-500">Pj</span> Store</h1>
