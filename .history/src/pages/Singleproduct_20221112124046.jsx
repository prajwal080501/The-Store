        ...
        <div className="w-[80%] bg-gray-100/20 shadow-sm  h-fit mb-5 mt-0 mx-auto p-5 rounded-md drop-shadow-md">
            <div>
                ...
                <div className="flex flex-col items-center justify-center">
                    <div className="flex flex-col lg:flex-row space-x-4 items-center justify-center mt-5">
                        <img src="https://i.ibb.co/S6qMxwr/jean.jpg" alt="" className="w-80 h-96 rounded-md" />
