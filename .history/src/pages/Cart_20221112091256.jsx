  ...
  return (
    ...
    <div className="container mx-auto mt-10">
      <div className="flex flex-col lg:flex-row shadow-m lg:space-x-5 my-10">
        <div className=" w-[90%] mx-auto lg:mx-0 lg:w-3/4 bg-white mb-10 rounded-md shadow-md px-10 py-10">
        ...
        <div id="summary" className="w-[90%] mx-auto lg:w-1/4 mt-10 lg:mt-0 px-8 py-10 bg-white mb-10 rounded-md shadow-md mt-5">
