...
const Login = ({ modalOpen, handleModal, setModalOpen }) => {
  return (
    ...
    <div className=`${modalOpen ? "fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-50 z-50 flex justify-center items-center" : "hidden"
    }`>
      <div className={`${modalOpen ? 'absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1/2 h-1/2 bg-white rounded-md' : 'hidden'}`
      }>
